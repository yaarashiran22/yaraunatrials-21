...
const AIAssistantPopup: React.FC<AIAssistantPopupProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6 bg-black/50 backdrop-blur-sm overflow-y-auto">
      <div className="w-full max-w-3xl lg:max-w-4xl my-auto">
        <Card className="w-full h-[70vh] lg:h-[75vh] max-h-[600px] flex flex-col bg-transparent border-0 rounded-3xl shadow-2xl">
