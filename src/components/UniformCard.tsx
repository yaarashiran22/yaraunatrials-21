          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center justify-between gap-1.5 mt-1">
              <div className="flex items-center gap-1.5">
                ...
                {(price || (type === 'event')) && (
                  <span className="text-xs font-medium px-2.5 py-0.5 bg-white backdrop-blur-md rounded-full text-black border border-white/40 shadow-lg transition-all duration-300 group-hover:bg-white/90 group-hover:scale-105">
                    {price ? `$${price}` : 'free'}
                  </span>
                )}
              </div>
