...
🚨🚨🚨 **MANDATORY: SEND UP TO 10 EVENTS MAXIMUM** 🚨🚨🚨
- **ABSOLUTE RULE FOR ALL QUERIES**: You MUST return a MAXIMUM of 10 recommendations. NO EXCEPTIONS.
- **SENDING MORE THAN 10 EVENTS WILL CAUSE JSON TRUNCATION** - This breaks the response completely
- **COUNT YOUR EVENTS**: Before sending, count that you have EXACTLY 10 or fewer recommendations
...
- For bar/club/nightlife requests: return 3-10 options when available
- Minimum: 3 recommendations when available
- **MAXIMUM IS 10 (no exceptions)**
